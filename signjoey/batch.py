...
class PoseBatch:
    ...
    def __init__(
        ...
        # Pose estimation
        # self.sgn, self.sgn_lengths = torch_batch.sgn
        self.body_2d, self.sgn_lengths = torch_batch.body_2d
        self.body_3d, _ = torch_batch.body_3d
        self.face_2d, _ = torch_batch.face_2d
        self.face_3d, _ = torch_batch.face_3d
        self.left_hand_2d, _ = torch_batch.left_hand_2d
        self.left_hand_3d, _ = torch_batch.left_hand_3d
        self.right_hand_2d, _ = torch_batch.right_hand_2d
        self.right_hand_3d, _ = torch_batch.right_hand_3d
    ...
    def _make_cuda(self):
        ...
        self.left_hand_2d = self.left_hand_2d.cuda()
        self.left_hand_3d = self.left_hand_3d.cuda()
        self.right_hand_2d = self.right_hand_2d.cuda()
        self.right_hand_3d = self.right_hand_3d.cuda()
    ...
    def sort_by_sgn_lengths(self):
        ...
        self.left_hand_2d = self.left_hand_2d[perm_index]
        self.left_hand_3d = self.left_hand_3d[perm_index]
        self.right_hand_2d = self.right_hand_2d[perm_index]  
        self.right_hand_3d = self.right_hand_3d[perm_index]  
        # self.sgn_mask = self.sgn_mask[perm_index]
        self.sgn_lengths = self.sgn_lengths[perm_index]
