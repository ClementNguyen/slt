...
from signjoey.model_dope import PoseModel, build_pose_model
from signjoey.data import load_pose_data, make_pose_data_iter
from signjoey.prediction_dope import validate_on_pose_data


# pylint: disable=too-many-instance-attributes
class DopeTrainManager:
    """ Manages training loop, validations, learning rate scheduling
    and early stopping."""

    def __init__(self, model: PoseModel, config: dict) -> None:
        """
    ...
    def train_and_validate(self, train_data: Dataset, valid_data: Dataset) -> None:
        ...
        """
        train_iter = make_pose_data_iter(
            train_data,
    ...
    def _train_batch(self, batch: PoseBatch, update: bool = True) -> (Tensor, Tensor):
        """
...
def train_dope(cfg_file: str) -> None:
    """
    ...
    train_data, dev_data, test_data, gls_vocab, txt_vocab = load_pose_data(
        data_cfg=cfg["data"]
    )
    ...
    trainer = DopeTrainManager(model=model, config=cfg)
...
if __name__ == "__main__":
    ...
    train_dope(cfg_file=args.config)
