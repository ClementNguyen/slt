...
from signjoey.prediction_feat import validate_on_feat_data


# pylint: disable=too-many-instance-attributes
class FeatTrainManager:
    """ Manages training loop, validations, learning rate scheduling
    and early stopping."""

    def __init__(self, model: FeatModel, config: dict) -> None:
        """
    ...
    def train_and_validate(self, train_data: Dataset, valid_data: Dataset) -> None:
        ...
        """
        train_iter = make_feat_data_iter(
            train_data,
    ...
    def _train_batch(self, batch: FeatBatch, update: bool = True) -> (Tensor, Tensor):
        """
...
def train_feat(cfg_file: str) -> None:
    ...
    trainer = FeatTrainManager(model=model, config=cfg)
